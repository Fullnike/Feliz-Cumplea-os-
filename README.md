...
<head>
    ...
    <style>
        /* --- Estilos de la Animación de Fondo (Canvas) --- */
        canvas {
            position: absolute;
            top: 0;
            left: 0;
            display: none; /* Se oculta hasta que se abra la carta */
            z-index: 1;
        }
        body {
        ...
        /* --- Estilos de la Carta y el Sobre --- */
        .container {
            position: relative;
            z-index: 10;
            cursor: pointer;
...
<div class="container" id="cardContainer" onclick="openGift()">
    <div class="envelope">
        <div class="card">
...
<script>
    ...
    function openGift() {
        ...
        if (!container.classList.contains('open')) {
            ...
            // Esperar un poco a que la carta suba para mostrar los fuegos artificiales
            setTimeout(() => {
    ...
    // --- Tu Código de Animación (Adaptado) ---
